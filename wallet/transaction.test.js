...
describe('Transaction', () =>{
    ...
    describe('validTransaction', () =>{
        ...
        describe('when the transasction is invalid', () =>{
            ...
            describe('and the transcation input signature is invalid',() =>{
                it('returns false and logs an error', () => {
    ...
    describe('update()' , () =>{
        ...
        describe('and the amount is valid', () =>{
            ...
            it('it maintains a total ouput that match the input amunt ', () =>{
